import crawlingBabyImage from 'src/assets/crawlingBabyImage.svg'; // 아기 기어다니는 사진을 import합니다.
import sleepingBabyImage from 'src/assets/sleepingBabyImage.svg'; // 아기 자는 사진을 import합니다.
import supermanBabyImage from 'src/assets/supermanBabyImage.svg'; // 아기 슈퍼맨 사진을 import합니다.
import cameraIcon from 'src/assets/cameraIcon.svg'; // 카메라 아이콘을 import합니다.
import myPageIcon from 'src/assets/myPageIcon.svg'; // 마이페이지 아이콘을 import합니다.
      ...
      <div className="w-full bg-white rounded-t-3xl pt-8 px-6 shadow-md mt-8 mb-0" style={{ height: '100%' }}>
        ...
        <div className="mb-4 p-4 bg-green-100 rounded-lg flex items-center">
          ...
          <div>
            ...
            <button className="mt-2 px-4 py-1 text-sm text-green-500 border border-green-500 rounded-full bg-white">
              주파수 분석중 <span>&gt;</span>
            </button>
          </div>
        </div>
        ...
        <div className="p-4 bg-red-100 rounded-lg flex items-center border-2 border-red-400 mb-4">
          ...
          <div>
            ...
            <button className="mt-2 px-4 py-1 text-sm text-red-500 border border-red-500 rounded-full bg-white">
              자세 감지중 <span>&gt;</span>
            </button>
          </div>
        </div>
